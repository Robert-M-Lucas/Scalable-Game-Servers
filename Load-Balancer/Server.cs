...
public class Server {
    ...
    public void Start() {
        Logger.LogInfo("Load Balancer server start");
        AcceptClientThread.Start();
    }

    public void AcceptClients(){
        Logger.LogInfo("Load Balancer Client Accept Thread Start");
